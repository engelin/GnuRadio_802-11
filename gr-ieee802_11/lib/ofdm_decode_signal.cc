...
//std::cout << cnt << "-th Frame " << " sig : " << sig_num << " " << d_nsym << "symbol num" << std::endl;
d_nsym = 0;
			deinterleave();
...
////////////////////////////////////////
//std::cout << "sssssssssssssssssssss " << cnt << "sig " << sig_num <<std::endl;
sig_num++;
			}
cnt++;
...
//////////////////////////////////////////
//std::cout << "ssss : " << cnt - 1<< ", " << sig_num - 1 << std::endl;
//std::cout << "d_nsym : " << d_nsym << " d_copy_symbols : " << d_copy_symbols << std::endl;
...
//std::cout << cnt << " signal field decodooooo!!!!!!!!!!!!!!!!!" << std::endl;
